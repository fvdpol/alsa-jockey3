...
#   sox -n -r 96000 -c 4 -b 24 -e signed-integer -t raw - synth 2 sine A3 gain -6 remix 0 1 0 0
   sox -n -r 96000 -c 4 -b 24 -e signed-integer -t raw - synth 2 sine D4 gain -6 remix 0 0 1 0	# HPL
#   sox -n -r 96000 -c 4 -b 24 -e signed-integer -t raw - synth 40 sine G4 gain -6 remix 0 0 0 1  # HPR
