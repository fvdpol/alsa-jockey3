 ...
 *    (tests/ploytec_model.py) guard against the whole family drifting away
 *    from the wire format together.
 *
...
/*
 * xorshift64*, mirrored bit-for-bit by tests/ploytec_model.py so the kernel
 * tests and the user-space bench see identical data.
 */
